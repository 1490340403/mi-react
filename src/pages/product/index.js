...
class Product extends React.Component{
    ...
    render(){
        ...
        <div className="item-video">
            ...
            <div className="video-bg" onClick={()=>this.setState({slide:true})}></div>
            <div className="video-box" >
                {
                    this.state.slide?<div className="overlay " ></div>:''
                }
                
                {/* v-if="slide" */}
                {/* :className="{'show':slide}" */}
                <div className={this.state.slide?'show video':'video'} >
                    <span className="icon-close" onClick={()=>this.setState({slide:false})}></span>
